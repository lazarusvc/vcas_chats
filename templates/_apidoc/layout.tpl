...
<head>
  ...
  <link href="{site_url}/templates/_apidoc/vendor/bootstrap.min.css" rel="stylesheet" media="screen">
  <link href="{site_url}/templates/_apidoc/vendor/prettify.css" rel="stylesheet" media="screen">
  <link href="{site_url}/templates/_apidoc/css/style.css" rel="stylesheet" media="screen, print">
  <link href="{site_url}/templates/_apidoc/img/favicon.ico" rel="icon" type="image/x-icon">
  <script src="{site_url}/templates/_apidoc/vendor/polyfill.js"></script>
  ...
  <script>
      ...
      window.sample_number = "{$data.number}";
      window.api_type = "{$data.type}";
  </script>
</head>
...
{/literal}
  ...
  <script data-main="{site_url}/templates/_apidoc/main.js" src="{site_url}/templates/_apidoc/vendor/require.min.js"></script>
