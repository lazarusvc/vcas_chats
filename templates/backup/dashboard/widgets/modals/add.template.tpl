        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group col-12">
                    <label>
                        {__("lang_form_name")} <i class="la la-info-circle" title="{__("lang_and_temp_line17")}"></i>
                    </label>
                    <input type="text" name="name" class="form-control" placeholder="eg. {__("lang_form_templatename_placeholder")}">
                </div>

                <div class="form-group col-12">
                    <label>
                        {__("lang_form_templateformat")} <i class="la la-info-circle" title="{__("lang_and_temp_line24")}"></i>
                    </label>
                    <textarea name="format" class="form-control" rows="5" placeholder="{__("lang_form_templateformat_placeholder")}"></textarea>
                </div>
                ...
                <div class="form-group col-12">
                    ...
                    <label>
                        {__("lang_form_shortcodes")} <i class="la la-info-circle" title="{__("lang_and_temp_line43")}"></i>
                    </label>
                    {literal}
                    <p>
