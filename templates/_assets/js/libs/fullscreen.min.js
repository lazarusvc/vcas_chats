(function(jQuery){function fullScreen(state)
{var e,func,doc;if(!this.length)return this;e=(this[0]);if(e.ownerDocument)
{doc=e.ownerDocument}
else{doc=e;e=doc.documentElement}
if(state==null)
...
{func.call(e)}
return this}
else{func=(doc.exitFullscreen)||(doc.webkitExitFullscreen)||(doc.webkitCancelFullScreen)||(doc.msExitFullscreen)||(doc.mozCancelFullScreen);if(func)func.call(doc);return this}}
...
else{change="fullscreenchange";error="fullscreenerror"}
jQuery(document).bind(change,fullScreenChangeHandler);jQuery(document).bind(error,fullScreenErrorHandler)}
jQuery.fn.fullScreen=fullScreen;jQuery.fn.toggleFullScreen=toggleFullScreen;installFullScreenHandlers()})(jQuery)