            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select name="match" class="form-control" zender-autoreply-type>
                        ...
                        <option value="4" {if $data.autoreply.match eq 4}selected{/if}>{__("lang_form_autoreply_modal_widget_matchtype_sel4")}</option>
                        <option value="5" {if $data.autoreply.match > 4}selected{/if}>{__("lang_form_none")}</option>
                    </select>
                </div>
