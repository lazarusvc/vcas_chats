            ...
            <div class="form-row">
                ...
                <div class="form-group col-12">
                    ...
                    <select name="theme_color" class="form-control">
                        <option value="light" {if $data.user.theme_color eq "light"}selected{/if}>{__("lang_theme_settings_defthemecolorlight")}</option>
                        <option value="dark" {if $data.user.theme_color eq "dark"}selected{/if}>{__("lang_theme_settings_defthemecolordark")}</option>
                    </select>
                </div>
