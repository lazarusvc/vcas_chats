...
class MessagingBookIt implements Messagingsms_PluginInterface, Messagingsms_Register_Interface {
    ...
    */
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Appointment pending SMS message', MESSAGINGSMS_TEXT_DOMAIN ),
                'desc'    => sprintf('Customize your SMS with <button type="button" id="messagingsms-open-keyword-%1$s-[dummy]" data-attr-type="appointment_pending" data-attr-target="%1$s[messagingsms_automation_sms_template_appointment_pending]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
            ...
            array(
                ...
                'label'   => __( 'Appointment approved SMS message', MESSAGINGSMS_TEXT_DOMAIN ),
                'desc'    => sprintf('Customize your SMS with <button type="button" id="messagingsms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[messagingsms_automation_sms_template_appointment_approved]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
            ...
            array(
                ...
                'label'   => __( 'Appointment cancelled SMS message', MESSAGINGSMS_TEXT_DOMAIN ),
                'desc'    => sprintf('Customize your SMS with <button type="button" id="messagingsms-open-keyword-%1$s-[dummy]" data-attr-type="pending" data-attr-target="%1$s[messagingsms_automation_sms_template_appointment_cancelled]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
    ...
    public function send_customer_notification($appointment, $status)
    {
        ...
        MessagingSMS_SendSMS_Sms::send_sms($validated_number, $message, $this->plugin_medium);
    }
