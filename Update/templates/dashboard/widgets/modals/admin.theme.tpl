        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group col-md-5">
                    <label>
                        {__("lang_theme_settings_defthemecolortitle")} <i class="la la-info-circle la-lg" title="{__("lang_theme_settings_defthemecolortooltip")}"></i>
                    </label>
                    <select name="default_scheme" class="form-control mb-3">
                        <option value="light" {if $data.system.default_scheme == "light"}selected{/if}>{__("lang_theme_settings_defthemecolorlight")}</option>
                        <option value="dark" {if $data.system.default_scheme == "dark"}selected{/if}>{__("lang_theme_settings_defthemecolordark")}</option>
                    </select>
                ...
                <div class="form-group col-md-7">
                    <label>
                        {__("lang_and_theme_line58")} <i class="la la-info-circle la-lg" title="{__("lang_and_theme_line58_1")}"></i>
                    </label>
